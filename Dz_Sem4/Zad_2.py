...
'''Пока что тяжело дается, попытался совместить этот код с Вашим со стрима, но видимо мало опыта,
 заменить '^' на '*' пока тоже не получилось. Сдаю так, потому что уже край)) '''
